        ...
        <div className="flex flex-col md:flex-row items-center md:items-start justify-between">
          <div className="md:w-1/2 p-4 text-xl">
            ...
            <p className="text-black text-xl mb-4">
              ...
              impact on the products and services that our clients offer. This
              This thorough analysis helps us to provide first-class time
              adjusted and immediately relevant, support and advisory on the
          ...
          <div className="md:w-1/2 p-4 text-xl">
            ...
            <p className="text-black text-xl mt-4">
              ...
              us in a position to understand how services and regulation in the
              sector affects other non-finance players equipping us with a great
              vantage view over and above finance legal to help create solutions
              that enable rather that deter your effectiveness. Our advisory
              will make you the perfect match for local finance needs in
              handling both public and private undertakings.
            </p>
          </div>
        </div>
      </div>
