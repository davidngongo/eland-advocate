      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-8">
          <h1 className="text-1xl text-black  text-maroon sm:text-2xl md:text-3xl">
            CONTRACTS COMPANY LAW AND COMMERCIAL CONTRACTS
          </h1>
        </div>
        <div className="flex flex-col md:flex-row items-center md:items-start justify-between">
          ...
          <div className="md:w-1/2 p-4">
            <p className="mb-4 text-xl text-black">
              ...
              contracts. Documentation for joint ventures, franchising and
            ...
            <p className="mb-4 text-xl text-black">
              ...
              record and forward thinking ethos enable us to help clients
              maneuver major hurdles in achieving their long-term business
              priorities. We take the trouble to deliver solutions that are not
              only practical, but also those that enhance your business values
              and objectives.
            </p>
          </div>
        </div>
