      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-8">
          <h1 className="text-1xl text-black  text-maroon sm:text-2xl md:text-3xl">
            DEVELOPMENT AGENCIES, INTER-GOVERMENTAL AND NOT FOR PROFIT
            ORGANIZATIONS
          </h1>
        </div>
        <div className="flex flex-col md:flex-row items-center md:items-start justify-between">
          ...
          <div className="md:w-1/2 p-4">
            ...
            <p className="text-black text-xl mb-4">
              ...
              judgment regarding both legal and practical consider- ations and
              extensive experience of interaction with the key people and
              entities that follow these issues.
            </p>
          </div>
        </div>
      </div>
